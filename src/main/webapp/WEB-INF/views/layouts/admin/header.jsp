...
<!--//charts-->
<!-- geo chart -->
<script src=<c:url value='/assets/admin/js/modernizr.min.js'/>
...
<script src=<c:url value="/assets/admin/js/skycons.js"/>
	type="text/javascript"></script>
<script src=<c:url value="/assets/admin/js/jquery.nicescroll.js"/>></script>
<script src=<c:url value="/assets/admin/js/scripts.js"/>
	type="text/javascript"></script>
		...
		<div class="header-left">
			<div class="logo-name">
				<a href="admin/index.htm">
					<h3>KaT Jewelry</h3> <!--<img id="logo" src="" alt="Logo"/>-->
				</a>
			</div>
			<!--search-box-->
